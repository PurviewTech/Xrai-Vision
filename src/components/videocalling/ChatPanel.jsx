...
const ChatPanel = ({ callId, userId, userName, onCloseChat }) => {
  ...
  useEffect(() => {
    ...
    const chatRef = ref(database, `videoCalls/${callId}/chatMessages`);
    ...
    <div className="absolute top-0 right-0 w-80 h-full bg-gray-700 p-4 flex flex-col shadow-lg z-30">
      ...
      <div className="flex-1 overflow-y-auto mb-2">
        {messages.map((msg, i) => (
          <div
            key={i}
            className={`mb-2 p-3 rounded-xl max-w-xs ${msg.senderId === userId
